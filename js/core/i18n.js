...
const STRINGS = {
  ...
  days:              ['days',                        'دن',                        'दिन'],
  nights:            ['nights',                      'راتیں',                     'रातें'],
  fridays:           ['Fridays',                     'جمعے',                      'जुमुए'],
  habit_goal:        ['Habit Goal',                  'عادت کا ہدف',               'आदत का लक्ष्य'],
  habit_goal_label:  ['I will read',                 'میں پڑھوں گا/گی',           'मैं पढ़ूंगा/पढ़ूंगी'],
  days_per_week:     ['days a week',                 'دن ہفتہ وار',               'दिन प्रति सप्ताह'],
  sunnah_goals:      ['Sunnah Goals',                'سنت کے اہداف',              'सुन्नत के लक्ष्य'],
  mulk_streak_label: ['Al-Mulk Streak',              'الملک سلسلہ',               'अल-मुल्क स्ट्रीक'],
  kahf_streak_label: ['Al-Kahf Streak',              'الکہف سلسلہ',               'अल-कहफ़ स्ट्रीक'],
  mulk_streak_sub:   ['Nights after Isha',           'عشاء کے بعد راتیں',         'इशा के बाद रातें'],
  kahf_streak_sub:   ['Consecutive Fridays',         'لگاتار جمعے',               'लगातार जुमुए'],
  mulk_target_label: ['My goal',                     'میرا ہدف',                  'मेरा लक्ष्य'],
  kahf_target_label: ['My goal',                     'میرا ہدف',                  'मेरा लक्ष्य'],
  ...
  ach_kahf_4:        ['4 Fridays — Al-Kahf',         '۴ جمعے — الکہف',            '४ जुमुए — अल-कहफ़'],
  ach_kahf_12:       ['12 Fridays — Al-Kahf',        '۱۲ جمعے — الکہف',           '१२ जुमुए — अल-कहफ़'],
  ach_mulk:          ['Al-Mulk Complete',            'الملک مکمل',                'अल-मुल्क पूरा'],
  ach_mulk_7:        ['7 Nights — Al-Mulk',          '۷ راتیں — الملک',           '७ रातें — अल-मुल्क'],
  ach_mulk_30:       ['30 Nights — Al-Mulk',         '۳۰ راتیں — الملک',          '३० रातें — अल-मुल्क'],
  ...
  celeb_sub_mulk_7:     ['7 nights of Al-Mulk — may Allah grant you its full protection.',
                          '۷ راتوں کی سورۃ الملک — اللہ آپ کو اس کی پوری حفاظت دے۔',
                          '७ रातों की सूरह अल-मुल्क — अल्लाह आपको इसकी पूरी हिफ़ाज़त दे।'],
  celeb_sub_mulk_30:    ['30 nights — a month of the protector. MashaAllah.',
                          '۳۰ راتیں — ایک مہینہ محافظ کے ساتھ۔ ماشاء اللہ۔',
                          '३० रातें — एक महीना हिफ़ाज़त करने वाले के साथ। माशाअल्लाह।'],
  celeb_sub_kahf_4:     ['4 consecutive Fridays with Al-Kahf — a month of light.',
                          '۴ لگاتار جمعے الکہف کے ساتھ — ایک مہینہ نور کا۔',
                          '४ लगातार जुमुए अल-कहफ़ के साथ — एक महीना नूर का।'],
  celeb_sub_kahf_12:    ['12 Fridays — three months of light between the two Fridays. SubhanAllah.',
                          '۱۲ جمعے — تین مہینے دو جمعوں کے درمیان نور۔ سبحان اللہ۔',
                          '१२ जुमुए — तीन महीने दो जुमुओं के बीच नूर। सुब्हानअल्लाह।'],
